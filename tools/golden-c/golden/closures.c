...
Tests_Counter* Tests_Counter_new(i64 start);
Tests_Program* Tests_Program_new();
void Tests_Counter_Increment(Tests_Counter* self);
void Tests_Counter_Add(Tests_Counter* self, i64 n);
code_string Tests_Counter_Report(Tests_Counter* self);
i64 Tests_Program_Apply(i64 x, i64 delta);
i64 Tests_Program_Clamp(i64 value, i64 min, i64 max);
...
Tests_Counter* Tests_Counter_new(i64 start) {
    Tests_Counter* self = (Tests_Counter*) GC_MALLOC(sizeof(Tests_Counter));
...
code_string Tests_Counter_Report(Tests_Counter* self) {
    ...
    return code_string_concat(code_string_concat("", "Counter = "), String_FromInt(self->Value));
}
...
void Tests_Program_Main(code_string* args) {
    ...
    Tests_Counter* c = Tests_Counter_new(0LL);
    #line 41 "tests/samples/closures.am"
    Tests_Counter_Increment(c);
    #line 42 "tests/samples/closures.am"
    Tests_Counter_Increment(c);
    #line 43 "tests/samples/closures.am"
    Tests_Counter_Add(c, 8LL);
    #line 44 "tests/samples/closures.am"
    Console_WriteLine(Tests_Counter_Report(c));
    #line 46 "tests/samples/closures.am"
    i64 v1 = Tests_Program_Apply(5LL, 3LL);
    #line 47 "tests/samples/closures.am"
    i64 v2 = Tests_Program_Apply(v1, -2LL);
    #line 48 "tests/samples/closures.am"
    Console_WriteLine(code_string_concat(code_string_concat(code_string_concat(code_string_concat("", "Apply: "), String_FromInt(v1)), " to "), String_FromInt(v2)));
    #line 50 "tests/samples/closures.am"
    i64 clamped = Tests_Program_Clamp(150LL, 0LL, 100LL);
    #line 51 "tests/samples/closures.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Clamp(150, 0, 100) = "), String_FromInt(clamped)));
    #line 53 "tests/samples/closures.am"
    i64 inner = Tests_Program_Clamp(200LL, 0LL, 100LL);
    #line 54 "tests/samples/closures.am"
    i64 outer = Tests_Program_Apply(10LL, 5LL);
    #line 55 "tests/samples/closures.am"
    i64 result = Tests_Program_Apply(inner, outer);
    #line 56 "tests/samples/closures.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Nested: "), String_FromInt(result)));
}
