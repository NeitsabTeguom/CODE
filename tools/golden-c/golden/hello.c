...
void MyApp_Program_Main(code_string* args);
...
MyApp_Program* MyApp_Program_new() {
    MyApp_Program* self = (MyApp_Program*) GC_MALLOC(sizeof(MyApp_Program));
    return self;
}
...
void MyApp_Program_Main(code_string* args) {
    ...
    Console_WriteLine(code_string_concat(code_string_concat(code_string_concat("", "Hello "), (name ? name : "")), " !"));
}
...
int main(int argc, char** argv) {
    ...
    MyApp_Program_Main((code_string*)argv);
