...
void Tests_Program_Main(code_string* args) {
    ...
    code_string label = (x > 5LL ? "big" : "small");
    #line 9 "tests/samples/if_expr.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "label: "), (label ? label : "")));
    #line 12 "tests/samples/if_expr.am"
    i64 score = 75LL;
    #line 13 "tests/samples/if_expr.am"
    code_string grade = (score >= 90LL ? "A" : (score >= 80LL ? "B" : (score >= 70LL ? "C" : "F")));
    #line 14 "tests/samples/if_expr.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "grade: "), (grade ? grade : "")));
    #line 17 "tests/samples/if_expr.am"
    i64 bigger = (x > 3LL ? x : 3LL);
    #line 18 "tests/samples/if_expr.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "bigger: "), String_FromInt(bigger)));
    #line 21 "tests/samples/if_expr.am"
    code_bool isAdult = (x >= 18LL ? 1 : 0);
    #line 22 "tests/samples/if_expr.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "adult: "), (isAdult ? "true" : "false")));
}
