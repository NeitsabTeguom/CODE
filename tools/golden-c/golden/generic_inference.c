...
void Tests_Program_Main(code_string* args) {
    #line 11 "tests/samples/generic_inference.am"
    AmalgameList* nums = AmalgameList_new();
    #line 12 "tests/samples/generic_inference.am"
    AmalgameList_add(nums, (void*)(intptr_t)(10LL));
    #line 13 "tests/samples/generic_inference.am"
    AmalgameList_add(nums, (void*)(intptr_t)(20LL));
    #line 14 "tests/samples/generic_inference.am"
    AmalgameList_add(nums, (void*)(intptr_t)(30LL));
    #line 15 "tests/samples/generic_inference.am"
    i64 total = ((i64)(intptr_t)AmalgameList_get(nums, 0LL) + (i64)(intptr_t)AmalgameList_get(nums, 1LL)) + (i64)(intptr_t)AmalgameList_get(nums, 2LL);
    #line 16 "tests/samples/generic_inference.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "total: "), String_FromInt(total)));
    #line 18 "tests/samples/generic_inference.am"
    AmalgameList* names = AmalgameList_new();
    #line 19 "tests/samples/generic_inference.am"
    AmalgameList_add(names, (void*)(intptr_t)("Arthus"));
    #line 20 "tests/samples/generic_inference.am"
    AmalgameList_add(names, (void*)(intptr_t)("Bastien"));
    #line 21 "tests/samples/generic_inference.am"
    code_string combined = code_string_concat((code_string_concat((code_string)AmalgameList_get(names, 0LL), " et ")), (code_string)AmalgameList_get(names, 1LL));
    #line 22 "tests/samples/generic_inference.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "combined: "), (combined ? combined : "")));
}
