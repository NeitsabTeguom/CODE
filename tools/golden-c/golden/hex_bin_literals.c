...
void Tests_Program_Main(code_string* args) {
    #line 5 "tests/samples/hex_bin_literals.am"
    i64 h1 = 0xFFLL;
    #line 6 "tests/samples/hex_bin_literals.am"
    i64 h2 = 0x10LL;
    #line 7 "tests/samples/hex_bin_literals.am"
    i64 h3 = 0XdeadLL;
    #line 8 "tests/samples/hex_bin_literals.am"
    i64 b1 = 10LL;
    #line 9 "tests/samples/hex_bin_literals.am"
    i64 b2 = 15LL;
    #line 10 "tests/samples/hex_bin_literals.am"
    i64 b3 = 0LL;
    #line 11 "tests/samples/hex_bin_literals.am"
    i64 sum = (h1 + h2) + b1;
    #line 12 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "h1="), String_FromInt(h1)));
    #line 13 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "h2="), String_FromInt(h2)));
    #line 14 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "h3="), String_FromInt(h3)));
    #line 15 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "b1="), String_FromInt(b1)));
    #line 16 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "b2="), String_FromInt(b2)));
    #line 17 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "b3="), String_FromInt(b3)));
    #line 18 "tests/samples/hex_bin_literals.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "sum="), String_FromInt(sum)));
}
