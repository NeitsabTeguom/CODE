...
i64 Tests_Program_Max(i64 a, i64 b);
code_string Tests_Program_Repeat(code_string s, i64 n);
...
Tests_Stack* Tests_Stack_new() {
    Tests_Stack* self = (Tests_Stack*) GC_MALLOC(sizeof(Tests_Stack));
...
void Tests_Stack_Push(Tests_Stack* self, i64 value) {
    ...
    self->Size = (self->Size + 1LL);
    #line 13 "tests/samples/generics.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Pushed: "), String_FromInt(value)));
}
...
Tests_Pair* Tests_Pair_new(code_string first, i64 second) {
    Tests_Pair* self = (Tests_Pair*) GC_MALLOC(sizeof(Tests_Pair));
...
code_string Tests_Pair_ToString(Tests_Pair* self) {
    ...
    return code_string_concat(code_string_concat(code_string_concat(code_string_concat(code_string_concat("", "("), (self->First ? self->First : "")), ", "), String_FromInt(self->Second)), ")");
}
...
void Tests_Program_Main(code_string* args) {
    ...
    Tests_Pair* p1 = Tests_Pair_new("hello", 42LL);
    #line 55 "tests/samples/generics.am"
    Tests_Pair* p2 = Tests_Pair_new("world", 99LL);
    ...
    Console_WriteLine(code_string_concat(code_string_concat("", "Max: "), String_FromInt(bigger)));
    #line 63 "tests/samples/generics.am"
    code_string rep = Tests_Program_Repeat("ab", 3LL);
    #line 64 "tests/samples/generics.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Repeat: "), (rep ? rep : "")));
}
