...
i64 App_Program_Clamp(i64 x, i64 lo, i64 hi);
code_string App_Program_Greet(code_string name);
...
i64 App_Program_Clamp(i64 x, i64 lo, i64 hi) {
    #line 7 "tests/samples/guard.am"
    if (!(x > lo)) {
        return lo;
    }
    #line 8 "tests/samples/guard.am"
    if (!(x < hi)) {
        return hi;
    }
    #line 9 "tests/samples/guard.am"
    return x;
}

code_string App_Program_Greet(code_string name) {
    #line 13 "tests/samples/guard.am"
    if (!(String_Length(name) > 0LL)) {
        return "Hello, stranger!";
    }
    #line 14 "tests/samples/guard.am"
    return code_string_concat((code_string_concat("Hello, ", name)), "!");
}

void App_Program_Main(code_string* args) {
    #line 18 "tests/samples/guard.am"
    Console_WriteLine(String_FromInt(App_Program_Clamp(5LL, 0LL, 10LL)));
    #line 19 "tests/samples/guard.am"
    Console_WriteLine(String_FromInt(App_Program_Clamp(0LL - 3LL, 0LL, 10LL)));
    #line 20 "tests/samples/guard.am"
    Console_WriteLine(String_FromInt(App_Program_Clamp(99LL, 0LL, 10LL)));
    #line 21 "tests/samples/guard.am"
    Console_WriteLine(App_Program_Greet("Bastien"));
    #line 22 "tests/samples/guard.am"
    Console_WriteLine(App_Program_Greet(""));
}
