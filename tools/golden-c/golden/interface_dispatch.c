...
struct Tests_Speaker_itab;
typedef struct { const struct Tests_Speaker_itab* itab; void* data; } Tests_Speaker;
typedef struct _Tests_Dog Tests_Dog;
typedef struct _Tests_Cat Tests_Cat;
...
Tests_Dog* Tests_Dog_new();
Tests_Cat* Tests_Cat_new();
Tests_Program* Tests_Program_new();
code_string Tests_Dog_Say(Tests_Dog* self);
code_string Tests_Cat_Say(Tests_Cat* self);
static code_string Tests_Program_Ask(Tests_Speaker s);
void Tests_Program_Main(code_string* args);
struct Tests_Speaker_itab {
    code_string (*Say)(void* self);
};
...
Tests_Dog* Tests_Dog_new() {
    Tests_Dog* self = (Tests_Dog*) GC_MALLOC(sizeof(Tests_Dog));
    return self;
}

code_string Tests_Dog_Say(Tests_Dog* self) {
    #line 15 "tests/samples/interface_dispatch.am"
    return "woof";
}

const struct Tests_Speaker_itab Tests_Dog__as__Tests_Speaker = { (code_string (*)(void* self)) Tests_Dog_Say };
...
Tests_Cat* Tests_Cat_new() {
    Tests_Cat* self = (Tests_Cat*) GC_MALLOC(sizeof(Tests_Cat));
    return self;
}

code_string Tests_Cat_Say(Tests_Cat* self) {
    #line 19 "tests/samples/interface_dispatch.am"
    return "meow";
}

const struct Tests_Speaker_itab Tests_Cat__as__Tests_Speaker = { (code_string (*)(void* self)) Tests_Cat_Say };
...
static code_string Tests_Program_Ask(Tests_Speaker s) {
    #line 25 "tests/samples/interface_dispatch.am"
    return s.itab->Say(s.data);
}

void Tests_Program_Main(code_string* args) {
    #line 29 "tests/samples/interface_dispatch.am"
    Tests_Dog* d = Tests_Dog_new();
    #line 30 "tests/samples/interface_dispatch.am"
    Tests_Cat* c = Tests_Cat_new();
    #line 32 "tests/samples/interface_dispatch.am"
    Console_WriteLine(Tests_Program_Ask((Tests_Speaker){ &Tests_Dog__as__Tests_Speaker, (void*)(d) }));
    #line 33 "tests/samples/interface_dispatch.am"
    Console_WriteLine(Tests_Program_Ask((Tests_Speaker){ &Tests_Cat__as__Tests_Speaker, (void*)(c) }));
}
