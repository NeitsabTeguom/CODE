...
Tests_Circle* Tests_Circle_new(code_string name, double radius);
Tests_Rectangle* Tests_Rectangle_new(code_string name, double width, double height);
Tests_Program* Tests_Program_new();
code_string Tests_Shape_Describe(Tests_Shape* self);
double Tests_Circle_Area(Tests_Circle* self);
code_string Tests_Circle_Describe(Tests_Circle* self);
double Tests_Rectangle_Area(Tests_Rectangle* self);
...
Tests_Shape* Tests_Shape_new(code_string name) {
    Tests_Shape* self = (Tests_Shape*) GC_MALLOC(sizeof(Tests_Shape));
...
code_string Tests_Shape_Describe(Tests_Shape* self) {
    ...
    return code_string_concat(code_string_concat("", "Shape: "), (self->Name ? self->Name : ""));
}
...
Tests_Circle* Tests_Circle_new(code_string name, double radius) {
    Tests_Circle* self = (Tests_Circle*) GC_MALLOC(sizeof(Tests_Circle));
...
code_string Tests_Circle_Describe(Tests_Circle* self) {
    ...
    return code_string_concat(code_string_concat(code_string_concat(code_string_concat("", "Circle '"), (self->Name ? self->Name : "")), "' r="), String_FromFloat(self->Radius));
}
...
Tests_Rectangle* Tests_Rectangle_new(code_string name, double width, double height) {
    Tests_Rectangle* self = (Tests_Rectangle*) GC_MALLOC(sizeof(Tests_Rectangle));
...
code_string Tests_Rectangle_Describe(Tests_Rectangle* self) {
    ...
    return code_string_concat(code_string_concat(code_string_concat(code_string_concat(code_string_concat(code_string_concat("", "Rectangle '"), (self->Name ? self->Name : "")), "' "), String_FromFloat(self->Width)), "x"), String_FromFloat(self->Height));
}
...
void Tests_Program_Main(code_string* args) {
    ...
    double ca = Tests_Circle_Area(c);
    #line 60 "tests/samples/inheritance.am"
    double ra = Tests_Rectangle_Area(r);
    #line 62 "tests/samples/inheritance.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Circle area: "), String_FromFloat(ca)));
    #line 63 "tests/samples/inheritance.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "Rectangle area: "), String_FromFloat(ra)));
}
