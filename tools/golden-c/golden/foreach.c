...
void Tests_Program_Main(code_string* args) {
    ...
    for (i64 i = 0LL; i < 5LL; i++) {
        #line 10 "tests/samples/foreach.am"
        sum = (sum + i);
    }
    #line 12 "tests/samples/foreach.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "sum 0..5: "), String_FromInt(sum)));
    #line 15 "tests/samples/foreach.am"
    AmalgameList* list = AmalgameList_new();
    #line 16 "tests/samples/foreach.am"
    AmalgameList_add(list, (void*)(intptr_t)(10LL));
    #line 17 "tests/samples/foreach.am"
    AmalgameList_add(list, (void*)(intptr_t)(20LL));
    #line 18 "tests/samples/foreach.am"
    AmalgameList_add(list, (void*)(intptr_t)(30LL));
    #line 20 "tests/samples/foreach.am"
    i64 total = 0LL;
    #line 21 "tests/samples/foreach.am"
    {
        AmalgameList* __it_item = list;
        i64 __len_item = AmalgameList_size(__it_item);
        for (i64 __idx_item = 0; __idx_item < __len_item; __idx_item++) {
            i64 item = (i64)(intptr_t)__it_item->data[__idx_item];
            #line 22 "tests/samples/foreach.am"
            total = (total + 1LL);
        }
    }
    #line 24 "tests/samples/foreach.am"
    Console_WriteLine(code_string_concat(code_string_concat("", "list total: "), String_FromInt(total)));
}
