...
/* inline-C top-level */
    ...
    typedef struct { i64 fd; } AmalgameH1Conn;
    static AmalgameH1Conn* _make_conn(i64 fd) {
        AmalgameH1Conn* c = (AmalgameH1Conn*) GC_MALLOC(sizeof(AmalgameH1Conn));
        c->fd = fd;
        return c;
    }
    static i64 _get_fd_from_int_conn(int c_as_int) {
        AmalgameH1Conn* c = (AmalgameH1Conn*)(intptr_t) c_as_int;
        return c->fd;
    }
...
i64 Demo_Bridge_FromConn(i64 c);
...
i64 Demo_Bridge_FromConn(i64 c) {
    #line 18 "/tmp/test-d3.am"
    i64 r = 0;
    #line 19 "/tmp/test-d3.am"
    { /* inline-C */
         r = _get_fd_from_int_conn(c); 
    }
    #line 20 "/tmp/test-d3.am"
    return r;
}
...
i64 Demo_Program_Main(code_string* args) {
    #line 26 "/tmp/test-d3.am"
    LamEnv_0* __env_0 = (LamEnv_0*) code_alloc(sizeof(LamEnv_0));
    AmalgameClosure* handler = AmalgameClosure_new((void*)lam_0_fn, __env_0);
    #line 32 "/tmp/test-d3.am"
    i64 rawConn = 0;
    #line 33 "/tmp/test-d3.am"
    { /* inline-C */
        
                    AmalgameH1Conn* c = _make_conn(42);
                    rawConn = (i64)(intptr_t) c;
                
    }
    #line 37 "/tmp/test-d3.am"
    i64 result = (i64)(intptr_t)AmalgameClosure_call1(handler, (void*)(intptr_t)(rawConn));
    #line 38 "/tmp/test-d3.am"
    Console_WriteLine(code_string_concat("fd=", String_FromInt(result)));
    #line 39 "/tmp/test-d3.am"
    return 0;
}
...
static void* lam_0_fn(void* __envRaw, void* __arg0) {
    ...
    #line 30 "/tmp/test-d3.am"
    return (void*)(intptr_t)(Demo_Bridge_FromConn(conn));
