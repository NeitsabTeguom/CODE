...
static i64 Tests_Program_Apply();
static i64 Tests_Program_Clamp();
...
static i64 Tests_Program_Apply(i64 x, i64 delta) {
...
static i64 Tests_Program_Clamp(i64 value, i64 min, i64 max) {
...
#line 39 "./tests/samples/closures.am"
    Tests_Counter* c = Tests_Counter_new(0);
...
#line 50 "./tests/samples/closures.am"
    i64 clamped = Tests_Program_Clamp(150, 0, 100);
...
#line 53 "./tests/samples/closures.am"
    i64 inner = Tests_Program_Clamp(200, 0, 100);

#line 54 "./tests/samples/closures.am"
    i64 outer = Tests_Program_Apply(10, 5);
