...
typedef struct _Demo_Util Demo_Util;
...
Demo_Util* Demo_Util_new();
Demo_Program* Demo_Program_new();
i64 Demo_Util_Double(i64 n);
...
Demo_Util* Demo_Util_new() {
    Demo_Util* self = (Demo_Util*) GC_MALLOC(sizeof(Demo_Util));
    return self;
}

i64 Demo_Util_Double(i64 n) {
    #line 5 "/tmp/test-d.am"
    return n * 2;
}
...
i64 Demo_Program_Main(code_string* args) {
    #line 14 "/tmp/test-d.am"
    LamEnv_0* __env_0 = (LamEnv_0*) code_alloc(sizeof(LamEnv_0));
    AmalgameClosure* cb = AmalgameClosure_new((void*)lam_0_fn, __env_0);
    #line 17 "/tmp/test-d.am"
    i64 r = (i64)(intptr_t)AmalgameClosure_call1(cb, (void*)(intptr_t)(21));
    #line 18 "/tmp/test-d.am"
    Console_WriteLine(code_string_concat("result=", String_FromInt(r)));
    #line 19 "/tmp/test-d.am"
    return 0;
}

static void* lam_0_fn(void* __envRaw, void* __arg0) {
    LamEnv_0* __env = (LamEnv_0*)__envRaw;
    i64 x = (i64)(intptr_t)__arg0;
    #line 15 "/tmp/test-d.am"
    return (void*)(intptr_t)(Demo_Util_Double(x));
